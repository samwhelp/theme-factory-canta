...
base_var_init () {
	...
	THE_SOURCE_THEME_ROOT_DIR_NAME="canta-icon-theme"
	...
	readonly THE_TARGET_THEME_BUILD_MAIN_NAME="canta"
	readonly THE_TARGET_THEME_BUILD_COLOR_LIST=("standard" "papirus" "breeze" "numix")
